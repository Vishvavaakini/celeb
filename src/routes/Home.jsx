...
const handleContinue = () =>{
 ...
 <div className="flex flex-wrap justify-center gap-3 mb-6">
    {["birthday","anniverdary","generic"].map((type)=>(
        <button key={type}
        type="button"
        onClick={()=>{
        ...
        className={`px-4 py-2 rounded-full text-sm border
            ${
                selectedType===type? "bg-pink-500 border-pink-400":
...
<div className="text-center">
    ...
    className="px-6 py-3 rounded-full bg-emerald-500 font-semiboldtext-sm">
        Continue ➜
    </button>
</div>
    </div>
